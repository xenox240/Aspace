	...
	async run(msg, { command }) {
		if (!command) {
			...
			try {
				...
				if (msg.channel.type !== 'dm') msgs.push(await msg.say("📬 Je t'ai envoyé un DM avec des informations."));
				return msgs;
			} catch {
				return msg.reply("Échec de l'envoi du DM. Vous avez probablement désactivé les DM.");
			}
		}
